          ...
          <div className="footer_inner">
            <div className="footer_info">
              <div className="info_sec">
                <Link aria-label="서비스 이용약관">서비스 이용약관</Link>
                <Link aria-label="개인정보 처리방침">개인정보 처리방침</Link>
                <Link aria-label="회사 안내">회사 안내</Link>
              </div>
              <div className="info_sec">
                <p>고객 센터<Link>cs@widit.co.kr</Link><Link>02-000-0000</Link></p>
                <p>광고 문의<Link>ad_sales@widit.co.kr</Link></p>
              </div>
              <div className="info_sec">
                <Link aria-label="위드잇">위드잇</Link>
                <Link aria-label="대표 김도하">대표 김도하</Link>
                <Link aria-label="서울특별시 영등포구 버드나루로 142">서울특별시 영등포구 버드나루로 142</Link>
